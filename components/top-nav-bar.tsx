...
export default function TopNavBar() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto px-6 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="flex items-center gap-4">
            {/* Notification bell */}
            <motion.button 
              className="relative p-1.5 rounded-full hover:bg-indigo-800/30 transition-colors"
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Link href="/settings" className="p-1.5 rounded-full hover:bg-indigo-800/30 transition-colors block">
            ...
            >
              <Link href="/auth/signin">
                <button className="py-1.5 px-4 bg-purple-600 hover:bg-purple-700 rounded-md transition-all duration-200 text-sm font-medium shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_20px_rgba(168,85,247,0.5)]">
                  {t("signIn")}
                </button>
              </Link>
            </motion.div>
